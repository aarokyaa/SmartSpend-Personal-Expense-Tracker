...
javac -encoding UTF-8 -d test-out src\Main.java src\CLI.java src\model\*.java src\repository\*.java src\service\*.java src\util\*.java src\report\*.java tests\*.java
